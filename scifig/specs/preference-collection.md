...
The chart-bundle question must be grounded in `knowledge/case-index.json` and the dedicated technique notes under `knowledge/techniques/`. Ask this card as:
...
_TEMPLATE_CHART_BUNDLE_SEEDS = {
    "computer_ai_ml": [
        {
            ...
            "techniqueRefs": ["knowledge/techniques/ml-model-diagnostics.md", "knowledge/techniques/marginal-joint.md"],
        ...
        },
        {
            ...
            "techniqueRefs": ["knowledge/techniques/ml-model-diagnostics.md", "knowledge/techniques/shap-composite.md"],
        ...
        },
        {
            ...
            "techniqueRefs": ["knowledge/techniques/ml-model-diagnostics.md", "knowledge/techniques/time-series-pi.md", "knowledge/techniques/shap-composite.md"],
        ...
        },
        {
            ...
            "techniqueRefs": ["knowledge/techniques/ml-model-diagnostics.md", "knowledge/techniques/time-series-pi.md"],
            "anchors": ["拒绝默认配色：Python 绘制多模型性能对比图的进阶实战_1777451272.md"],
        ...
        },
        {
            ...
            "techniqueRefs": ["knowledge/techniques/radar.md", "knowledge/techniques/shap-composite.md", "knowledge/techniques/heatmap-pairwise.md", "knowledge/techniques/ml-model-diagnostics.md"],
            "anchors": ["基于PSO多目标优化与SHAP可解释分析的回归预测模型框架_1777461729.md"],
        ...
        },
        {
            ...
            "techniqueRefs": ["knowledge/techniques/ml-model-diagnostics.md"],
            "anchors": ["拒绝默认配色：Python 绘制多模型性能对比图的进阶实战_1777451272.md"],
    ...
    "clinical_diagnostics_survival": [
        {
            ...
            "families": ["forest"],
            "techniqueRefs": ["knowledge/techniques/dual-axis.md"],
        ...
        },
        {
            ...
            "techniqueRefs": ["knowledge/techniques/marginal-joint.md", "knowledge/techniques/inset-distribution.md"],
    ...
    "genomics_transcriptomics": [
        {
            ...
            "techniqueRefs": ["knowledge/techniques/heatmap-pairwise.md"],
        ...
        },
        {
            ...
            "techniqueRefs": ["knowledge/techniques/shap-composite.md", "knowledge/techniques/heatmap-pairwise.md"],
        ...
        },
        {
            ...
            "techniqueRefs": ["knowledge/techniques/heatmap-pairwise.md", "knowledge/techniques/marginal-joint.md"],
    ...
    "materials_engineering": [
        ...
        },
        {
            ...
            "techniqueRefs": ["knowledge/techniques/dual-axis.md", "knowledge/techniques/time-series-pi.md"],
    ...
    "_default": [
        {
            ...
            "charts": ["scatter_regression", "residual_vs_fitted", "bland_altman", "histogram"],
            "families": ["marginal_joint", "density_scatter"],
            "techniqueRefs": ["knowledge/techniques/marginal-joint.md"],
            "anchors": ["复现 CEJ 顶刊神图 _ Python 绘制“密度散点+边缘直方图”多面板组合图_1777452838.md"],
        ...
        },
        {
            ...
            "charts": ["lollipop_horizontal", "dotplot", "scatter_regression", "heatmap_annotated", "correlation"],
            "families": ["shap_composite", "heatmap_pairwise"],
            "techniqueRefs": ["knowledge/techniques/shap-composite.md"],
            "anchors": ["复现顶刊 _ 拒绝千篇一律的SHAP图，用Matplotlib手绘一张“蜂群+条形”组合图_1777452577.md"],
