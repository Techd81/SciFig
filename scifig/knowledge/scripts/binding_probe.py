...
Usage (autonomous distillation cycles):
    python scifig/knowledge/scripts/binding_probe.py
...
SOURCE_FILES = [
    SKILL_ROOT / "runtime" / "generators_clinical.py",
    SKILL_ROOT / "runtime" / "generators_composition.py",
    SKILL_ROOT / "runtime" / "generators_diagnostics.py",
    SKILL_ROOT / "runtime" / "generators_distribution.py",
    SKILL_ROOT / "runtime" / "generators_engineering.py",
    SKILL_ROOT / "runtime" / "generators_genomics.py",
    SKILL_ROOT / "runtime" / "generators_matrix.py",
    SKILL_ROOT / "runtime" / "generators_ml.py",
    SKILL_ROOT / "runtime" / "generators_network.py",
    SKILL_ROOT / "runtime" / "generators_radar.py",
    SKILL_ROOT / "runtime" / "generators_ranked.py",
    SKILL_ROOT / "runtime" / "generators_scatter.py",
    SKILL_ROOT / "runtime" / "generators_time_series.py",
]
SMOKE_SOURCE_FILES = SOURCE_FILES + [
    SKILL_ROOT / "phases" / "03-code-gen-style.md",
    SKILL_ROOT / "phases" / "04-export-report.md",
    SKILL_ROOT / "runtime" / "helpers.py",
    SKILL_ROOT / "runtime" / "template_mining_helpers.py",
    SKILL_ROOT / "resources" / "finalizer-safe-template-contract.md",
    SKILL_ROOT / "resources" / "layout-recipes-ready.json",
    SKILL_ROOT / "resources" / "zorder-recipes-ready.json",
]
