...
- Committable skill changes stay under `scifig`.
...
7. Promote only reusable elements into the skill:
   - motif -> `specs/template-visual-motifs.md` or `knowledge/modules/05-annotation-idioms.md`
   - layout -> `knowledge/modules/04-grid-recipes.md` or `resources/layout-recipes-ready.json`
   - helper -> `runtime/template_mining_helpers.py` or `runtime/helpers.py`
