...
This folder contains generator-ready resources extracted from `knowledge/`.
...
with (Path(skill_root) / "resources" / "template-palette-registry.json").open(encoding="utf-8") as f:
...
- `resources/template-palette-registry.json`
- `resources/layout-recipes-ready.json`
- `resources/zorder-recipes-ready.json`

`runtime/template_mining_helpers.py` is responsible for loading these
