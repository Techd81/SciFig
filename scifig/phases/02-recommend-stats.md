...
- `resources/panel-layout-recipes.md`
- `resources/palette-presets.md`
...
def recommend_chart_bundle(dataProfile, workflowPreferences):
    ...
    IMPLEMENTED_CHARTS = {
        # Mirrors runtime/registry.py; every registered key has a gen_ implementation.
...
def infer_template_visual_motifs(charts, dataProfile):
    ...
    has_hump_threshold_regression_signal = (
        ...
        or (
            ...
            and any(token in tokens for token in ("hump", "threshold", "breakpoint", "changepoint", "驼峰", "阈�?, "soc", "cue"))
        )
    )
...
_TEMPLATE_CASE_INDEX_PATH = Path("scifig/knowledge/case-index.json")
...
def resolve_template_case_plan(primaryChart, secondaryCharts, workflowPreferences, dataProfile=None):
    ...
    technique_by_family = {
        "marginal_joint": "knowledge/techniques/marginal-joint.md",
        "density_scatter": "knowledge/techniques/marginal-joint.md",
        "density_parity_matrix": "knowledge/techniques/density-parity-matrix.md",
        "ml_model_diagnostics": "knowledge/techniques/ml-model-diagnostics.md",
        "shap_composite": "knowledge/techniques/shap-composite.md",
        "heatmap_pairwise": "knowledge/techniques/heatmap-pairwise.md",
        "radar": "knowledge/techniques/radar.md",
        "dual_axis": "knowledge/techniques/dual-axis.md",
        "time_series_pi": "knowledge/techniques/time-series-pi.md",
        "gradient_box": "knowledge/techniques/gradient-box.md",
        "inset_distribution": "knowledge/techniques/inset-distribution.md",
        "pls_pm_path_model": "knowledge/techniques/pls-pm-path-model.md",
    }
    anchor_by_family = {
        "ml_model_diagnostics": [
            "期刊复现：基于随机森�?RF)的多维模型性能评估与预测残差可视化图谱_1777456409.md",
            "拒绝默认配色：Python 绘制多模型性能对比图的进阶实战_1777451272.md",
            "期刊复现：随机森�?RF)模型驱动的EFI特征重要度条形图与SHAP圆环图可视化_1777456510.md",
        ],
        "shap_composite": [
            "复现顶刊 _ 拒绝千篇一律的SHAP图，用Matplotlib手绘一张“蜂�?条形”组合图_1777452577.md",
        ],
        "marginal_joint": [
            "Python 科研绘图：如何优雅地展示“模型精�?稳定性”？顶刊可视化复盘_1777452458.md",
        ],
    }
...
def build_palette_plan(primaryChart, dataProfile, workflowPreferences, templateCasePlan=None):
    ...
    # Chart-family aware palette routing �?corpus-anchored choices (knowledge/modules/03-palette-bank.md).
