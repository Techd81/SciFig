...
| `classifier_validation_board` | score/probability + binary label, AUC/F1/precision/recall, threshold tuning, or true/predicted classes | Four-panel classifier board: ROC discrimination, PR curve, calibration bins, and threshold sweep with compact confusion sidecar | `templateMotifCount`, `metricTableCount`, `referenceLineCount` |
