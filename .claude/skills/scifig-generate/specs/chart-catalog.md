...
| `rf_classifier_report_board` | ✅ | Random Forest/RF + score/label + feature importance/SHAP/gain, including stacked prediction/importance rows | RF classifier validation plus feature-importance report board |
