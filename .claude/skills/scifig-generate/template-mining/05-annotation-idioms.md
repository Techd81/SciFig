...
- 9 pt bold, matched to the active journal profile
- Position `(-0.06, 1.08)` axes fraction; keep the label outside the data rectangle
...
def add_panel_label(ax, label: str, *, x=-0.06, y=1.08, fontsize=9) -> None: ...
```
