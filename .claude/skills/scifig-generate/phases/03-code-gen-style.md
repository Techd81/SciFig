...
- metadata fields: `legendContractEnforced`, `layoutContractEnforced`, `legendOutsidePlotArea`, `axisLegendRemainingCount`, `layoutContractFailures`, `metricTableDataOverlapCount`, `metricTableRelocatedCount`, `metricTableSuppressedCount`, `visualGrammarMotifsApplied`, `templateMotifsApplied`, `templateCaseAnchors`, `templateTechniqueRefs`, `templateMatchMode`, `metricTableCount`, `referenceLineCount`, `densityHaloCount`, `marginalAxesCount`, `densityColorEncodingCount`
