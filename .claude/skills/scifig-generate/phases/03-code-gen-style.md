...
- metadata fields: `legendContractEnforced`, `layoutContractEnforced`, `legendOutsidePlotArea`, `axisLegendRemainingCount`, `layoutContractFailures`, `metricTableDataOverlapCount`, `visualGrammarMotifsApplied`, `templateMotifsApplied`, `templateCaseAnchors`, `templateTechniqueRefs`, `templateMatchMode`, `metricTableCount`, `referenceLineCount`, `densityHaloCount`, `marginalAxesCount`, `densityColorEncodingCount`
